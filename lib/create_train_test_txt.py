...
def get_sample_value(txt_name, category_name):
    # label_path = './label_2/'
    # label_path = '/media/ExtHDD/cc/datasets/kitti_2d_detection/data_preprocess/Labels_modified/'
    # label_path = 'D:\ws_pycharm\kitti_data_processing\data_origin/trainval\label_2_modified/'
    label_path = 'E:\py-projects\SSD-TF\converter\kitti_2d_detection\label_2_modified/'
...
# txt_list_path = glob.glob('/media/ExtHDD/cc/datasets/kitti_2d_detection/data_preprocess/Labels_modified/*.txt')
# txt_list_path = glob.glob('D:\ws_pycharm\kitti_data_processing\data_origin/trainval\label_2_modified/*.txt')
txt_list_path = glob.glob('E:\py-projects\SSD-TF\converter\kitti_2d_detection\label_2_modified/*.txt')
txt_list = []
...
# Main_path = '/media/ExtHDD/cc/datasets/kitti_2d_detection/data_preprocess/Voc_kitti/ImagesSets/Main/'
# Main_path = 'D:\ws_pycharm\kitti_data_processing\data_origin/trainval/voc_kitti_trainval\ImagesSets\Main/'
Main_path = 'E:\py-projects\SSD-TF\converter\kitti_voc\TxtSets/'
