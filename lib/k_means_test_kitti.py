    ...
    def process_file(self):
       ...
       # print (self.txt_path)
        for file in os.listdir(self.voc_path):
            ...
            #xml_parse = PascalVocReader(file_path, 1000, 450)
            xml_parse = PascalVocReader(file_path, 512, 512
                                        )
...
if __name__ == '__main__':
     ...
     whtxt = create_w_h_txt("./kitti_voc/kittivoc_trainval/Annotations","./data1.txt") #指定为voc标注路径，以及存放生成文件路径
     whtxt.process_file()
